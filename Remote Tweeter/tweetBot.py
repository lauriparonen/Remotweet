...
e.g. if the user wishes to be preserved from exposure to information overload.
...
The program presupposes:
    ...
    they should be in a text file named 'twitterkeys.txt' located in the Python file directory.
    (Alternatively you can just put them as variables where the all_keys-indices are)
    - Tweepy
